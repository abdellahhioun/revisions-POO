...
class Product {
    ...
    public function create(PDO $pdo) {
        // Convertir le tableau de photos en JSON pour l'insertion
        ...
        if ($stmt->execute()) {
            ...
            return false;  // Indicateur que l'insertion a échoué
        }
    }
    ...
    public function update(PDO $pdo) {
        ...
        if ($stmt->execute()) {
            return $this; // Retourner l'instance mise à jour
        } else {
            return false; // Indicateur que la mise à jour a échoué
        }
    }
